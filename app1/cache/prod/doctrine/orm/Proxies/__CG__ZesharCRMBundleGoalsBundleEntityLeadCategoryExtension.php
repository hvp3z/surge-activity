 ...
 */
class LeadCategoryExtension extends \ZesharCRM\Bundle\GoalsBundle\Entity\LeadCategoryExtension implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZesharCRM\\Bundle\\GoalsBundle\\Entity\\LeadCategoryExtension' . "\0" . 'goal');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LeadCategoryExtension $proxy) {
    ...
    public function addGoal(\ZesharCRM\Bundle\GoalsBundle\Entity\Goal $goal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addGoal', array($goal));
    ...
    public function removeGoal(\ZesharCRM\Bundle\GoalsBundle\Entity\Goal $goal)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeGoal', array($goal));

        return parent::removeGoal($goal);
    }
