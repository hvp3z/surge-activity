 ...
 */
class UserExtension extends \ZesharCRM\Bundle\GoalsBundle\Entity\UserExtension implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZesharCRM\\Bundle\\GoalsBundle\\Entity\\UserExtension' . "\0" . 'goalAssignments', '' . "\0" . 'ZesharCRM\\Bundle\\GoalsBundle\\Entity\\UserExtension' . "\0" . 'createdGoals', 'id', 'leadCategories', 'leadEventTypes', 'leadSources', 'leadTypes', 'payments', 'creditCards', 'billingInfo', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserExtension $proxy) {
    ...
    public function addCreatedGoal(\ZesharCRM\Bundle\GoalsBundle\Entity\Goal $createdGoals)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCreatedGoal', array($createdGoals));

        return parent::addCreatedGoal($createdGoals);
    }
    ...
    public function removeCreatedGoal(\ZesharCRM\Bundle\GoalsBundle\Entity\Goal $createdGoals)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCreatedGoal', array($createdGoals));

        return parent::removeCreatedGoal($createdGoals);
    }
    ...
    public function getCreatedGoals()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCreatedGoals', array());

        return parent::getCreatedGoals();
    }
    ...
    public function addGoalAssignment(\ZesharCRM\Bundle\GoalsBundle\Entity\GoalAssignment $goalAssignments)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addGoalAssignment', array($goalAssignments));

        return parent::addGoalAssignment($goalAssignments);
    }
    ...
    public function removeGoalAssignment(\ZesharCRM\Bundle\GoalsBundle\Entity\GoalAssignment $goalAssignments)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeGoalAssignment', array($goalAssignments));

        return parent::removeGoalAssignment($goalAssignments);
    }
    ...
    public function getGoalAssignments()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getGoalAssignments', array());

        return parent::getGoalAssignments();
    }
