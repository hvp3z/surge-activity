 ...
 */
class OpportunityAttachment extends \ZesharCRM\Bundle\CoreBundle\Entity\OpportunityAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\OpportunityAttachment' . "\0" . 'id', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\OpportunityAttachment' . "\0" . 'attachment', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\OpportunityAttachment' . "\0" . 'opportunity');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OpportunityAttachment $proxy) {
