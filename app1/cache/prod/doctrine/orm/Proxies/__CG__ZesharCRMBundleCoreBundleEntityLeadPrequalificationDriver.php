 ...
 */
class LeadPrequalificationDriver extends \ZesharCRM\Bundle\CoreBundle\Entity\LeadPrequalificationDriver implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationDriver' . "\0" . 'id', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationDriver' . "\0" . 'name', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationDriver' . "\0" . 'dob', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationDriver' . "\0" . 'license', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationDriver' . "\0" . 'ageLicensed', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationDriver' . "\0" . 'tickets', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationDriver' . "\0" . 'lead');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LeadPrequalificationDriver $proxy) {
    ...
    public function setAgeLicensed($ageLicensed)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAgeLicensed', array($ageLicensed));

        return parent::setAgeLicensed($ageLicensed);
    }
    ...
    public function getAgeLicensed()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAgeLicensed', array());

        return parent::getAgeLicensed();
    }
