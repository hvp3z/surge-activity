 ...
 */
class LeadSource extends \ZesharCRM\Bundle\CoreBundle\Entity\LeadSource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadSource' . "\0" . 'id', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadSource' . "\0" . 'title', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadSource' . "\0" . 'creator', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadSource' . "\0" . 'lead');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LeadSource $proxy) {
