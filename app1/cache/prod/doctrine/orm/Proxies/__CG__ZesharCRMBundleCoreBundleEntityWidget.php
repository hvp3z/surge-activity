 ...
 */
class Widget extends \ZesharCRM\Bundle\CoreBundle\Entity\Widget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\Widget' . "\0" . 'id', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\Widget' . "\0" . 'title', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\Widget' . "\0" . 'height', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\Widget' . "\0" . 'width', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\Widget' . "\0" . 'serviceId');
        }
