 ...
 */
class LeadPrequalificationAuto extends \ZesharCRM\Bundle\CoreBundle\Entity\LeadPrequalificationAuto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationAuto' . "\0" . 'id', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationAuto' . "\0" . 'year', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationAuto' . "\0" . 'make', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationAuto' . "\0" . 'model', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationAuto' . "\0" . 'vinNumber', '' . "\0" . 'ZesharCRM\\Bundle\\CoreBundle\\Entity\\LeadPrequalificationAuto' . "\0" . 'lead');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LeadPrequalificationAuto $proxy) {
